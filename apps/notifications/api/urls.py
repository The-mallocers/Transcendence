...
from apps.notifications.api.views import GetFriendsApiView, GetPendingFriendsApiView, GetPendingDuelsApiView, GetUserName, GetImages
...
urlpatterns = [
    ...
    path('get_duels_images/', GetImages.as_view(), name='image'),
