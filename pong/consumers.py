...
class MyConsumer(WebsocketConsumer):
    ...
    def start_game_loop(self):
        import threading
        self.game_loop_task = threading.Thread(target=self.game_loop, daemon=True)
    ...
    def update_game_state(self):
        ...
        # Top paddle
        if (self.game_state.ball_y <= self.game_state.PADDLE_HEIGHT + self.game_state.BALL_RADIUS and
